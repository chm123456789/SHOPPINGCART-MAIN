                    ...
                    <Row>
                        ...
                        <Col xs={24} xl={4} style={{width:'100%'}}>
                            <div className={GoodStyle.menu} style={{ display: "flex", marginRight: '0px', alignItems: 'right' }}>
                                ...
                                <span >
                                    <Menu style={{border: '1px solid #f0f0f0',borderRadius:'10px', backgroundColor:'black'}} mode="horizontal" defaultSelectedKeys={['1']} >
                                        <SubMenu style={{fontweight: '900' },{color:'yellow'} }title="Racking">
